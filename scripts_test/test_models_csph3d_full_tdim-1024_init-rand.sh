...
ckpt_id=epoch=29-step=103889-avgvalrmse=0.0172.ckpt #  | 120 images== | 128 images==
...
ckpt_id=epoch=29-step=103889-avgvalrmse=0.0178.ckpt #  | 120 images== | 128 images==
python test.py dataset='"'$test_dataset'"' ++model_name='"'$model_name'"' ++experiment_name=$experiment_name ++model_dirpath='"'$model_dirpath'"' ++ckpt_id='"'$ckpt_id'"' ++train_dataset='"'$train_dataset'"'
...
ckpt_id=epoch=24-step=86574-avgvalrmse=0.0188.ckpt #  | 120 images== | 128 images==
python test.py dataset='"'$test_dataset'"' ++model_name='"'$model_name'"' ++experiment_name=$experiment_name ++model_dirpath='"'$model_dirpath'"' ++ckpt_id='"'$ckpt_id'"' ++train_dataset='"'$train_dataset'"'
...
ckpt_id=epoch=29-step=103889-avgvalrmse=0.0155.ckpt #  | 120 images== | 128 images==
python test.py dataset='"'$test_dataset'"' ++model_name='"'$model_name'"' ++experiment_name=$experiment_name ++model_dirpath='"'$model_dirpath'"' ++ckpt_id='"'$ckpt_id'"' ++train_dataset='"'$train_dataset'"'
...
ckpt_id=epoch=29-step=102158-avgvalrmse=0.0162.ckpt #  | 120 images== | 128 images==
python test.py dataset='"'$test_dataset'"' ++model_name='"'$model_name'"' ++experiment_name=$experiment_name ++model_dirpath='"'$model_dirpath'"' ++ckpt_id='"'$ckpt_id'"' ++train_dataset='"'$train_dataset'"'
...
ckpt_id=epoch=28-step=100426-avgvalrmse=0.0172.ckpt #  | 120 images== | 128 images==
python test.py dataset='"'$test_dataset'"' ++model_name='"'$model_name'"' ++experiment_name=$experiment_name ++model_dirpath='"'$model_dirpath'"' ++ckpt_id='"'$ckpt_id'"' ++train_dataset='"'$train_dataset'"'
