...
ckpt_id=epoch=25-step=90037-avgvalrmse=0.0660.ckpt #  | 120 images== | 128 images==1.267
...
ckpt_id=epoch=17-step=60602-avgvalrmse=0.0664.ckpt #  | 120 images== | 128 images==1.313
python test.py dataset='"'$test_dataset'"' ++model_name='"'$model_name'"' ++experiment_name=$experiment_name ++model_dirpath='"'$model_dirpath'"' ++ckpt_id='"'$ckpt_id'"' ++train_dataset='"'$train_dataset'"'
...
ckpt_id=epoch=18-step=64065-avgvalrmse=0.2630.ckpt #  | 120 images== | 128 images==5.791 (Not converged)
python test.py dataset='"'$test_dataset'"' ++model_name='"'$model_name'"' ++experiment_name=$experiment_name ++model_dirpath='"'$model_dirpath'"' ++ckpt_id='"'$ckpt_id'"' ++train_dataset='"'$train_dataset'"'
...
ckpt_id=epoch=28-step=98695-avgvalrmse=0.0245.ckpt #  | 120 images== | 128 images==0.115
python test.py dataset='"'$test_dataset'"' ++model_name='"'$model_name'"' ++experiment_name=$experiment_name ++model_dirpath='"'$model_dirpath'"' ++ckpt_id='"'$ckpt_id'"' ++train_dataset='"'$train_dataset'"'
## 1D Temporal CSPH - tblock_init=HybridGrayFourier)
...
ckpt_id=epoch=29-step=103889-avgvalrmse=0.0246.ckpt #  | 120 images== | 128 images==0.113
python test.py dataset='"'$test_dataset'"' ++model_name='"'$model_name'"' ++experiment_name=$experiment_name ++model_dirpath='"'$model_dirpath'"' ++ckpt_id='"'$ckpt_id'"' ++train_dataset='"'$train_dataset'"'
## 1D Temporal CSPH - tblock_init=Rand + Opt Codes)
...
experiment_name=csph3D_tdim_baselines
model_dirpath=outputs/${train_dataset}/${experiment_name}/${model_name}/run-complete_2022-10-17_213238
ckpt_id=epoch=29-step=103889-avgvalrmse=0.2630.ckpt #  | 120 images== | 128 images==5.791
python test.py dataset='"'$test_dataset'"' ++model_name='"'$model_name'"' ++experiment_name=$experiment_name ++model_dirpath='"'$model_dirpath'"' ++ckpt_id='"'$ckpt_id'"' ++train_dataset='"'$train_dataset'"'
