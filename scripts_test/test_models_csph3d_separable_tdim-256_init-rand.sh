...
# [PENDING RUNNING IN COMPOPTICS B.C IT NEVER RAN] ## # 3D CSPH 256x8x8 - Compression=32x --> k=512
...
ckpt_id=epoch=29-step=103887-avgvalrmse=0.0180.ckpt #  128 images==0.018125 | 128 images large depth (9m offset): | 128 images large depth (7m offset):  | 128 images masked tbins (9m): 
python test.py dataset='"'$test_dataset'"' ++model_name='"'$model_name'"' ++experiment_name=$experiment_name ++model_dirpath='"'$model_dirpath'"' ++ckpt_id='"'$ckpt_id'"' ++train_dataset='"'$train_dataset'"'
...
# ckpt_id=epoch=29-step=103887-avgvalrmse=0.0188.ckpt #  128 images==0.020129 | 128 images large depth (9m offset): | 128 images large depth (7m offset):  | 128 images masked tbins (9m): 
# python test.py dataset='"'$test_dataset'"' ++model_name='"'$model_name'"' ++experiment_name=$experiment_name ++model_dirpath='"'$model_dirpath'"' ++ckpt_id='"'$ckpt_id'"' ++train_dataset='"'$train_dataset'"'
