...
experiment_name=baselines
model_dirpath=outputs/${train_dataset}/${experiment_name}/${model_name}/loss-kldiv_tv-1e-5/2022-05-02_085659
...
model_name=DDFN_C64B10_Depth2Depth
experiment_name=baselines
model_dirpath=outputs/${train_dataset}/${experiment_name}/${model_name}/loss-kldiv_tv-0.0/2022-05-07_171658
