...
# ckpt_id=epoch=06-step=22509-avgvalrmse=0.0261.ckpt # 72 images == 0.01700 | 128 images == 0.01756
...
# ckpt_id=epoch=03-step=13851-avgvalrmse=0.0280.ckpt # 72 images == 0.01744 | 128 images == 0.0301
# python test.py dataset='"'$test_dataset'"' ++model_name='"'$model_name'"' ++experiment_name=$experiment_name ++model_dirpath='"'$model_dirpath'"' ++ckpt_id='"'$ckpt_id'"' ++train_dataset='"'$train_dataset'"'
...
# ckpt_id=epoch=29-step=102158-avgvalrmse=0.0178.ckpt # 72 images == 0.01538 | 128 images ==0.0761
# python test.py dataset='"'$test_dataset'"' ++model_name='"'$model_name'"' ++experiment_name=$experiment_name ++model_dirpath='"'$model_dirpath'"' ++ckpt_id='"'$ckpt_id'"' ++train_dataset='"'$train_dataset'"'
...
# # ckpt_id=epoch=00-step=1731-avgvalrmse=0.0266.ckpt # 72 images == 0.0178 | 128 images == 0.0185
# # python test.py dataset='"'$test_dataset'"' ++model_name='"'$model_name'"' ++experiment_name=$experiment_name ++model_dirpath='"'$model_dirpath'"' ++ckpt_id='"'$ckpt_id'"' ++train_dataset='"'$train_dataset'"'
# # ## [STATUS=DONE] LR=1e-3, TV=0.0, Normalization=Linf --> divide each histogram by its maximum
# # model_name=DDFN_C64B10/norm-Linf/loss-kldiv_tv-0.0
# # experiment_name=no_compression_baselines_lr-1e-3
# # model_dirpath=outputs/${train_dataset}/${experiment_name}/${model_name}/run-complete_2022-10-13_051558
# # ckpt_id=epoch=28-step=98695-avgvalrmse=0.0136.ckpt # 72 images == 0.0128 | 128 images == 0.0330
# # python test.py dataset='"'$test_dataset'"' ++model_name='"'$model_name'"' ++experiment_name=$experiment_name ++model_dirpath='"'$model_dirpath'"' ++ckpt_id='"'$ckpt_id'"' ++train_dataset='"'$train_dataset'"'
...
# ckpt_id=epoch=03-step=12120-avgvalrmse=0.0348.ckpt # 72 images == 0.03755 | 128 images == 0.03453
# python test.py dataset='"'$test_dataset'"' ++model_name='"'$model_name'"' ++experiment_name=$experiment_name ++model_dirpath='"'$model_dirpath'"' ++ckpt_id='"'$ckpt_id'"' ++train_dataset='"'$train_dataset'"'
...
ckpt_id=epoch=29-step=102158-avgvalrmse=0.0249.ckpt # 72 images == 0.0349 | 128 images == 0.0383
python test.py dataset='"'$test_dataset'"' ++model_name='"'$model_name'"' ++experiment_name=$experiment_name ++model_dirpath='"'$model_dirpath'"' ++ckpt_id='"'$ckpt_id'"' ++train_dataset='"'$train_dataset'"'
# ## [STATUS=DONE] LR=1e-3, TV=1e-5
# model_name=DDFN_C64B10_Depth2Depth/loss-kldiv_tv-1e-05
# experiment_name=no_compression_baselines_lr-1e-3
# model_dirpath=outputs/${train_dataset}/${experiment_name}/${model_name}/run-complete_2022-10-13_051558
# ckpt_id=epoch=01-step=5194-avgvalrmse=0.0347.ckpt # 72 images == 0.0356 | 128 images == 0.0366
# python test.py dataset='"'$test_dataset'"' ++model_name='"'$model_name'"' ++experiment_name=$experiment_name ++model_dirpath='"'$model_dirpath'"' ++ckpt_id='"'$ckpt_id'"' ++train_dataset='"'$train_dataset'"'
# ## [STATUS=DONE] LR=1e-3, TV=0.0
# model_name=DDFN_C64B10_Depth2Depth/loss-kldiv_tv-0.0
# experiment_name=no_compression_baselines_lr-1e-3
# model_dirpath=outputs/${train_dataset}/${experiment_name}/${model_name}/run-complete_2022-10-13_051558
# ckpt_id=epoch=28-step=98695-avgvalrmse=0.0212.ckpt # 72 images == 0.02189 | 128 images == 0.02428
# python test.py dataset='"'$test_dataset'"' ++model_name='"'$model_name'"' ++experiment_name=$experiment_name ++model_dirpath='"'$model_dirpath'"' ++ckpt_id='"'$ckpt_id'"' ++train_dataset='"'$train_dataset'"'
