...
> **IMPORTANT NOTE from 2024-03-18:** The code in this repository still needs to be cleaned up and organized for better reproducibility. In the meantime, if you have any questions about the code, please create an issue. There is currently on thread that has been started: https://github.com/felipegb94/learned-compressive-spad-histograms-iccv2023/issues/8
