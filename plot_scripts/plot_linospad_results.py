...
if __name__=='__main__':
    ...
    experiment_name = 'debug_generalization'
    out_base_dirpath = './results/week_2022-08-29/linospad_results'
    out_dirpath = os.path.join(out_base_dirpath, experiment_name)
    ...
    dataset = Lindell2018LinoSpadDataset(datalist_fpath='datalists/{}.txt'.format(linospad_dataset_id))
    ...
    plot_utils.save_currfig(dirpath = out_base_dirpath, filename=scene_id)
    ...
    ## CSPH3D Separable Models
    model_dirpaths.append('outputs/nyuv2_64x64x1024_80ps/csph3d_debug_generalization/DDFN_C64B10_CSPH3Dv2/k512_down4_Mt1_HybridGrayFourier-optCt=False-optC=True_separable_norm-LinfGlobal/loss-kldiv_tv-0.0/run-complete_2022-08-29_195412')
    model_dirpaths.append('outputs/nyuv2_64x64x1024_80ps/csph3d_debug_generalization/DDFN_C64B10_CSPH3Dv2/k128_down4_Mt1_HybridGrayFourier-optCt=False-optC=True_separable_norm-LinfGlobal/loss-kldiv_tv-0.0/run-complete_2022-08-29_195412')
    ...
    model_dirpaths.append('outputs/nyuv2_64x64x1024_80ps/csph3d_good_norm/DDFN_C64B10_CSPH3Dv2/k512_down4_Mt1_Rand-optCt=True-optC=True_full_norm-LinfGlobal/loss-kldiv_tv-0.0/run-complete_2022-08-24_144556')
    ...
    ## ZNCC normalization
    model_dirpaths.append('outputs/nyuv2_64x64x1024_80ps/csph3d_debug_generalization/DDFN_C64B10_CSPH3D/k512_down4_Mt1_Rand-optCt=True-optC=True_full_norm-none_irf-False_zn-True_zeromu-True_smoothtdimC-False/loss-kldiv_tv-0.0/run-complete_2022-08-30_125727')
    model_dirpaths.append('outputs/nyuv2_64x64x1024_80ps/csph3d_debug_generalization/DDFN_C64B10_CSPH3D/k512_down4_Mt1_Rand-optCt=True-optC=True_full_norm-LinfGlobal_irf-False_zn-True_zeromu-True_smoothtdimC-False/loss-kldiv_tv-0.0/run-complete_2022-08-30_232221')
    model_dirpaths.append('outputs/nyuv2_64x64x1024_80ps/csph3d_debug_generalization/DDFN_C64B10_CSPH3D/k512_down4_Mt1_Rand-optCt=True-optC=True_full_norm-none_irf-False_zn-False_zeromu-True_smoothtdimC-False/loss-kldiv_tv-0.0/run-complete_2022-08-30_125727')
