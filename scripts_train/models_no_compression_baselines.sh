...
## [STATUS=DONE] LR=1e-4, TV=1e-5
python train.py ++experiment=coarsehist_peak_compression_baseline model=DDFN_C64B10_KBinHistDepth2Depth ++train_params.epoch=30 ++random_seed=1235 ++train_params.batch_size=4 ++resume_train=true ++train_params.p_tv=1e-5 ++train_params.lri=1e-4
