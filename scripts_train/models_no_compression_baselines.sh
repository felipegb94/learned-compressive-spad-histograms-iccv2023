...
## LR=1e-4, TV=1e-5, Normalization=None (Same params as original paper)
...
## LR=1e-4, TV=1e-5, Normalization=Linf --> divide each histogram by its maximum
...
## LR=1e-4, TV=0.0, Normalization=Linf --> divide each histogram by its maximum
...
## LR=1e-3, TV=1e-5, Normalization=Linf --> divide each histogram by its maximum
...
## LR=1e-3, TV=0.0, Normalization=Linf --> divide each histogram by its maximum
