#### Spatio-temporal CSPH with separable kernel encodings that are NOT Optimized
# The following commands train CSPH3D models with coding matrices that have spatio-temporal encoding kernels with dimensions 256x4x4, and these kernels are not optimized during training
# Experimental configs:
#   - Encoding Kernels (Block Dims) = [256x4x4]
