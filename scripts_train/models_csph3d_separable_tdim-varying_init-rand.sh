...
# [STATUS==PENDING] 3D CSPH 256x4x4 - Compression=256x --> k=16
...
# [STATUS==PENDING] 3D CSPH 256x4x4 - Compression=512x --> k=8
...
# [STATUS==PENDING] 3D CSPH 64x4x4 - Compression=256x --> k=4
...
# [STATUS==PENDING] 3D CSPH 64x4x4 - Compression=512x --> k=2
