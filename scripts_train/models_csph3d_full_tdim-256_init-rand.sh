...
# [STATUS==PENDING] 3D CSPH 256x8x8 - Compression=32x --> k=512
...
# [STATUS==PENDING] 3D CSPH 256x8x8 - Compression=64x --> k=256
...
# [STATUS==PENDING] 3D CSPH 256x8x8 - Compression=128x --> k=128
