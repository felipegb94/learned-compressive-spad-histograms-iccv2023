...
## [STATUS==DONE] 1D Temporal CSPH - tblock_init=TruncFourier)
...
## [STATUS==DONE] 1D Temporal CSPH - tblock_init=HybridGrayFourier)
...
## [STATUS==DONE] 1D Temporal CSPH - tblock_init=CoarseHist)
...
## [STATUS==DONE] 1D Temporal CSPH - tblock_init=Rand)
...
# [STATUS==DONE] 1D Temporal CSPH - tblock_init=Rand + Opt Codes)
