function [est_depthbin] = EstDepthBinsLogMatchedFilter(hist_img, psf)
...
% Add 1 to PSF to avoid log(0)
corr_scores = CircXCorr(log(1+vec_psf), vec_hist_img);

% Get maximum bin
[~, est_depthbin] = max(corr_scores, [], 2);
